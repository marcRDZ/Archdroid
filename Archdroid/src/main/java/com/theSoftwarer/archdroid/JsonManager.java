...
public class JsonManager {
    ...
    public static void createMarkersFromJson(String json, GoogleMap googleMap, LatLngBounds latLngBounds) throws JSONException {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (jsonObj.getJSONObject("geometry").getString("type").equals("Point")) {
                    ...
                    googleMap.addMarker(new MarkerOptions().position(new LatLng(
                                    ...
                                    .icon(BitmapDescriptorFactory.fromResource(getCustomMarker(placeType)))
                    );
                }
    ...
    private static int getCustomMarker(String string) {
    ...
    private static final HashMap<String, Integer> iconsMap;
    static
    {
